                ...
                >
                  ...
                  <div className="mt-5 flex gap-3 border-t border-slate-100 dark:border-slate-700/50 pt-4">
                    <Link 
                        ...
                        className="flex-[3] rounded-md bg-[#0277bd] px-3 py-2 text-xs font-bold text-white text-center transition-colors hover:bg-[#01579b] shadow-sm flex items-center justify-center"
                    >
